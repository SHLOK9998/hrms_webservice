...
import { Building2, LogOut, ChevronRight, Users2 } from 'lucide-react'
    ...
    <div className="flex h-screen bg-surface-950 overflow-hidden">
      ...
      <aside className={`${collapsed ? 'w-20' : 'w-64'} transition-all duration-300 flex flex-col bg-surface-900 border-r border-slate-800 flex-shrink-0`}>
        ...
        <div className="p-3 border-t border-slate-800">
          {!collapsed && (
            <div className="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl bg-slate-800/50 mb-2">
          ...
          {collapsed && (
            <div className="flex items-center justify-center w-full p-2.5 rounded-xl bg-slate-800/50 mb-2">
